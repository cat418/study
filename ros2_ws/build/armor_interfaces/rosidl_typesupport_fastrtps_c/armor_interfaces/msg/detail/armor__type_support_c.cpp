...
#include "armor_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point32__functions.h"  // apexs
#include "geometry_msgs/msg/detail/pose__functions.h"  // pose, world_pose
...
using _Armor__ros_msg_type = armor_interfaces__msg__Armor;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: distance_to_center
  {
    cdr << ros_message->distance_to_center;
  }
  ...
  // Field name: apexs
  {
    ...
    size_t size = 4;
    auto array_ptr = ros_message->apexs;
  ...
  size_t current_alignment)
{
  ...
  // field.name distance_to_center
  {
    size_t item_size = sizeof(ros_message->distance_to_center);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name apexs
...
static uint32_t _Armor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_armor_interfaces__msg__Armor(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces__msg__Armor;
    is_plain =
      (
      offsetof(DataType, world_pose) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Armor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_armor_interfaces__msg__Armor(
