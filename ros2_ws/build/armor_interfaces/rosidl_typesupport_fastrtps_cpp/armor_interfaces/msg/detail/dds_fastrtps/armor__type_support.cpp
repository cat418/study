...
#include "armor_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const armor_interfaces::msg::Armor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  armor_interfaces::msg::Armor & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  // Member: apexs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.apexs[index], current_alignment);
    }
  }
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces::msg::Armor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armor_interfaces::msg::Armor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<armor_interfaces::msg::Armor *>(
    untyped_ros_message);
...
get_message_type_support_handle<armor_interfaces::msg::Armor>()
{
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armor_interfaces, msg, Armor)() {
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
