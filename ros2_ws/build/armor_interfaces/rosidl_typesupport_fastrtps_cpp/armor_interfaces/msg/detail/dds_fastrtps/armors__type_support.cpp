...
#include "armor_interfaces/msg/detail/armors__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const armor_interfaces::msg::Armor &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const armor_interfaces::msg::Armors & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: armors
  {
    ...
    for (size_t i = 0; i < size; i++) {
      armor_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  armor_interfaces::msg::Armors & ros_message)
{
  // Member: header
  ...
  // Member: armors
  {
    ...
    for (size_t i = 0; i < size; i++) {
      armor_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        armor_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        armor_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Armor(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces::msg::Armors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armor_interfaces::msg::Armors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<armor_interfaces::msg::Armors *>(
    untyped_ros_message);
...
{
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_Armors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armor_interfaces, msg, Armors)() {
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_Armors__handle;
}
