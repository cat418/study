...
#define NODE_MAIN_LOGGER_NAME "armor_sub_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_sub.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ArmorSubNode>";
