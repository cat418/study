...
#define NODE_MAIN_LOGGER_NAME "armor_pub_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_pub.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ArmorPubNode>";
